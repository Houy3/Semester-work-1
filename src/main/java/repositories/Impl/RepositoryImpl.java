...
public class RepositoryImpl implements Repository {
    ...
    @Override
    public final void delete(Object object, Field uniqueField) throws NotFoundException, DBException, ServiceException {
    ...
    @Override
    public final void selectByUniqueField(Object object, Field uniqueField) throws NotFoundException, DBException, ServiceException {
        allParamChecks(object, uniqueField);
    ...
    private void allParamChecks(Object object, Field uniqueField) throws ServiceException, DBException {
        objectCheck(object);
        uniqueFieldCheck(object, uniqueField);
    }
    ...
    /** Проверка уникального поля, что оно не null
                                 и что его содержимое не null */
    private void uniqueFieldCheck(Object object, Field uniqueField) throws ServiceException {
        if (object == null) {
            throw new ServiceException("Объект не передан. ");
        }
        if (uniqueField == null) {
        ...
        if (getValueFrom(object, uniqueField) == null) {
            throw new ServiceException("Поле не заполнено. ");
        }
    }
    ...
    private void uniqueCheck(Object object) throws NotUniqueException, DBException, ServiceException {
